...
<title>Thêm Mới Một Danh Mục</title>
<link rel="stylesheet" type="text/css" href="formdanhmuc.css" />
</head>
<body>
    ...
    <tr id="body">
        ...
        <td align="right" valign="top" width="650px">
            ...
            <table width="640px" id="main-content" border="0px" cellpadding="0px" cellspacing="0px">
                ...
                <tr height="50">
                	<td class="form"><label>tên danh mục sản phẩm mới</label><br><input type="text" name="cat_name" /></td>
                </tr>
                <tr height="50">
