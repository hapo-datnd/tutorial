        ...
        <td align="right" valign="top" width="650px">
            ...
            <table width="640px" id="main-content" border="0px" cellpadding="0px" cellspacing="0px">
            	<tr id="main-navbar" height="36px">
                	<td colspan="6">quản lý sản phẩm <a href="#">thêm sản phẩm mới (+)</a></td>
                </tr>
                ...
                <tr class="product-item">
                	<td class="text">iPhone 3Gs - Black</td>
                    <td class="red text">600 $</td>
                    <td class="text">iPhone</td>
                    <td class="img"><img src="images/img-thumb.gif" /></td>
                    <td class="link"><a href="#">sửa</a></td>
                    <td class="link"><a class="red" href="#">xóa</a></td>
                </tr>
                <tr class="product-item">
                	<td class="text">iPhone 3Gs - Black</td>
                    <td class="red text">600 $</td>
                ...
                <tr id="list-num" height="30px">
                	<td align="right" colspan="6"><a href="#">1</a> <a href="#">2</a> <a href="#">3</a> <a href="#">4</a> <b><a href="#">5</a></b> <a href="#">6</a> <a href="#">7</a> <a href="#">8</a> <a href="#">9</a> <a href="#">10</a></td>
                </tr>
            </table>
            <!-- End Main Content -->
        </td>
